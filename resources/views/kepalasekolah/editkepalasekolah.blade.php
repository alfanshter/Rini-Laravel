...
@enderror
 ...
 @if (auth()->user()->role == 3)
    <form action="/kepalasekolah/updatepassword" method="POST">
 @else
  ...
  <div class="mb-3">
    ...
    @if (auth()->user()->role == 3)
        <input disabled type="number" class="form-control" id="nohp" name="nohp" value="{{old('nohp',$kepalasekolah->nohp)}}">
    @else 
  ...
  <div class="mb-3">
    ...
    @if (auth()->user()->role == 3)
        <input disabled type="text" class="form-control" id="username" name="username" value="{{old('username',$kepalasekolah->username)}}">
    @else 
