...
<form action="/updateagenda" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nama_materi" required name="nama_materi" value="{{old('nama_materi',$dataagenda->nama_materi)}}">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="tahun_ajaran" required name="tahun_ajaran" value="{{old('tahun_ajaran',$dataagenda->tahun_ajaran)}}">
    </div>
    <div class="mb-3">
